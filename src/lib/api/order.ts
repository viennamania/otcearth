...
export async function getUsdtPrice(data: any) {
  ...
  const collection = client.db('otcearth').collection('setup');
...
export async function insertSellOrder(data: any) {
  ...
  const userCollection = client.db('otcearth').collection('users');
  ...
  const collection = client.db('otcearth').collection('orders');
...
export async function updateOne(data: any) {
  const client = await clientPromise;
  const collection = client.db('otcearth').collection('users');
...
export async function insertBuyOrder(data: any) {
  ...
  */
  ...
  const collection = client.db('otcearth').collection('buyorders');
